...
<div class="card my-4 px-0 container">
                    ...
                    <div class="card-body">
                        ...
                        <form action={{ route('employee.update',$employee->id) }} method="post" enctype="maltipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="form-check  mb-3">
                                <input class="form-check-input" type="checkbox" value=1 name="status"@if($employee->status=1) checked @endif>
